...
## Screenshot
![image](https://github.com/ViswasSomapongu/pong-game/assets/145599843/8a1cd5fc-f3f1-483b-98e1-62a1af8badbd)
...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/ViswasSomapongu/pong-game.git
   cd Pong-Game
   ```
...
3. Enjoy the game and feel free to explore the code to understand how it works!
...
6. Create a pull request (PR) describing your changes. Please maintain clear and concise code, and ensure the game remains user-friendly.
